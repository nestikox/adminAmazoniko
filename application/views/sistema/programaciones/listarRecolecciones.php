...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   <!-- Content Header (Page header) -->
					...
					<h1>Recolecciones programadas
						<small>Información de recolecciones y postulados.</small>
					</h1>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
						<li >Programaciones</li>
                        <li class="active">Listar Recolecciones</li>
					</ol>
				</section>
    <!-- Main content -->
        ...
        $(document).ready(function(){
          $("#infoModal").modal();
            ...
            var tabla = $('#rutas').DataTable( {
                ...
                "serverSide": true,
                "ordering": false,
                "ajax": "<?=site_url('ajax_request/get_recolecciones')?>",
                "language": es
                });
