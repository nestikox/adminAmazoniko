<header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg" style="opacity:0.5;"><b>Amazoniko</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php $url = site_url('sistema');?>
          <a href="<?php echo (isset($valid) and $valid==0)?$url.'?w=1':$url;?>">
        ...
        $group = 'members'; if($this->ion_auth->in_group($group)): /*OPCIONES DE RECOLECTORES*/?>
          <?php if(isset($valid) and $valid==0):?>
            <li class="<?php echo isset($op_tips)?$op_tips:'';?>">
              <a href="<?php echo site_url('usuarios/perfilUsuario');?>">
                <i class="	fa fa-check-square-o"></i> <span>Actualizar datos <i class="fa fa-exclamation-triangle"></i></span>
              </a>
            </li>
          <?php endif;?>
          <li class="<?php echo isset($op_tips)?$op_tips:'';?>">
          <?php if(isset($valid) and $valid==0):?>
          <a href="#" class="disabled" title="Debe completar la informacion de registro">
        ...
        <?php if(isset($valid) and $valid==0):?>
          ...
          <?php else:?>
          <a href="http://190.146.247.240/amazoniko/site/store/amazoniko/" target="_blank">
            <i class="fa fa-shopping-cart"></i> <span> Redimibles</span>
          </a>
          <?php endif;?>
        </li>
        ...
        <li class="treeview <?php echo (isset($rutas_main)?$rutas_main:'');?>">
					<a href="#">
						<i class="fa fa-map" aria-hidden="true"></i> <span>Zonas de recolección</span>
          ...
          <a href="<?php echo site_url('usuarios')?>">
            ...
            <!--<span class="pull-right-container"> <small class="label pull-right bg-green">new</small> </span>-->
				...
				<li class="treeview <?php echo (isset($rutas_main)?$rutas_main:'');?>">
					...
					<ul class="treeview-menu">
            <li><a href="<?=site_url('usuarios/rutas')?>"><i class="fa fa-cogs" aria-hidden="true"></i> Recolectores -> Zonas</a></li>
        ...
        <li class="treeview <?php echo (isset($prog_sel)?$prog_sel:'');?>">
            ...
            <li><a href="<?=site_url('programaciones/listarRecolecciones')?>"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Ver Recolecciones</a></li>
					</ul>
        </li>
