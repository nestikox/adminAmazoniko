...
<div class="login-box">
  ...
  <div class="login-box-body" style="border-radius: 5px;box-shadow: 0px 3px 15px black;background-color: rgba(255,255,255,0.5)!important">
    ...
    <form action="<?php echo site_url('inicio/registrarUsuario');?>" method="post" id="registroForm">
        ...
        <div class="form-group has-feedback">
            <input type="email" class="form-control" id="emailc" onpaste="return false;" autocomplete="off" name="correoc" aria-describedby="correohelpc" placeholder="Confirmar email" required>
			<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
...
<script>
  $(function(){ $('input').iCheck({checkboxClass: 'icheckbox_square-blue',radioClass: 'iradio_square-blue',increaseArea: '20%'}); });
    ...
    function validateForm(e){
        ...
        var addr = document.getElementById('dir');
